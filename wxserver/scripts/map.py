...
cmdline = './start_node.py --node map1 --linehost %s  --host %s'%(mischost,host)
os.system(cmdline)
cmdline = './start_node.py --node map2 --linehost %s  --host %s'%(mischost,host)
os.system(cmdline)
cmdline = './start_node.py --node map3 --linehost %s  --host %s'%(mischost,host)
os.system(cmdline)
cmdline = './start_node.py --node map4 --linehost %s  --host %s'%(mischost,host)
os.system(cmdline)
