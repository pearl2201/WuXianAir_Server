...
cmdline = './start_node.py --node map5 --linehost %s  --host %s'%(mischost,host)
os.system(cmdline)
cmdline = './start_node.py --node map6 --linehost %s  --host %s'%(mischost,host)
os.system(cmdline)
cmdline = './start_node.py --node map7 --linehost %s  --host %s'%(mischost,host)
os.system(cmdline)
cmdline = './start_node.py --node map8 --linehost %s  --host %s'%(mischost,host)
os.system(cmdline)
