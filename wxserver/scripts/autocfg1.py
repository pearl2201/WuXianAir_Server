...
cmd =cmd + ' --map1 $MAP1IP$ --map2 $MAP1IP$ --map3 $MAP1IP$ '
cmd =cmd + ' --gate1 $GATEIP$ --gate2 $GATEIP$ --gate3 $GATEIP$ '
...
cmd = replace_bench(cmd,['$GATEIP$','$MAP1IP$','$MISCIP$','$MIN_PORT$','$MAX_PORT$','$PREFIX$'],[gateip,map1ip,miscip,PortMin,PortMax,Prefix])
